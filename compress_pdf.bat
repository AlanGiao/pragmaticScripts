...
@echo off
set "GS_PATH=C:\Program Files\gs\gs10.06.0\bin\gswin64c.exe"
...
for %%f in (*.pdf) do (
    ...
    "%GS_PATH%" -sDEVICE=pdfwrite -dCompatibilityLevel=1.4 -dPDFSETTINGS=/ebook -dNOPAUSE -dQUIET -dBATCH -sOutputFile="%OUTPUT_DIR%\%%f" "%%f"
